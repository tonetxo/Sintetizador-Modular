...
export class Phaser extends BaseEffect {
    constructor(audioContext, x, y, id = null, initialState = {}) {
        ...
        this.knobDefs = [
            ...
            // --- CORRECCIÓN --- Rango de Feedback reducido para mayor control y menos distorsión
            { name: 'feedback', label: 'Feedback', min: 0, max: 0.9, initial: 0.7 }
        ];
