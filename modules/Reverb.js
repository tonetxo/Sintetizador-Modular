...
export class Reverb {
    constructor(x, y, id = null, initialState = {}) {
        ...
        this.params = {
            ...
            duration: initialState.duration || 2.0
        };
    ...
    _createImpulseResponse() {
        ...
        const length = sampleRate * this.params.decay; // Usar o decay para a duración
    ...
    handleDragInteraction(worldPos) {
        ...
        if (this.activeControl === 'decay') {
            this._createImpulseResponse(); // Regenerar IR cando cambia o decay
        }
        this.updateParams();
    }
