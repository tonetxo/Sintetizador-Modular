...
class LFOProcessor extends AudioWorkletProcessor {
    ...
    process(inputs, outputs, parameters) {
        ...
        // Comprobamos si el array de canales de salida y el primer canal existen.
        if (!output || !output[0]) {
            return true; // Si no, salimos, pero mantenemos el procesador activo.
        }
