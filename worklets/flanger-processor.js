// worklets/flanger-processor.js
class FlangerProcessor extends AudioWorkletProcessor {
    static get parameterDescriptors() {
        return [
            { name: 'rate', defaultValue: 0.5, minValue: 0.01, maxValue: 5 },
            { name: 'depth', defaultValue: 0.0025, minValue: 0.0005, maxValue: 0.005 },
            { name: 'delay', defaultValue: 0.005, minValue: 0.001, maxValue: 0.02 },
    ...
    constructor() {
        super();
        this.buffer = new Float32Array(sampleRate * 0.1); // Max delay de 100ms
        this.writeIndex = 0;
        this.lfoPhase = 0;
    }
